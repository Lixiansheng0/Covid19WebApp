    ...
    <div class="case-num">
        <div class="container">
            <div class="title">
                <span
                    >截至
                    {{ formatData(caseNum.modifyTime) }} 全国数据统计</span
                >
            </div>
        </div>
        <div class="num">
                        ...
                        <div class="create-count">
                            <b
                                >较昨日<em style="color: rgb(247, 76, 49)">{{
                                    caseNumChange(caseNum.currentConfirmedIncr)
                                }}</em></b
                            >
                        </div>
                        ...
                        <div class="create-count">
                            <b
                                >较昨日<em style="color: rgb(247, 130, 7)">{{
                                    caseNumChange(caseNum.confirmedIncr)
                                }}</em></b
                            >
                        </div>
                        <strong style="color: rgb(247, 130, 7)">{{
                            caseNum.confirmedCount
                        }}</strong>
                        <span>累计确诊</span>
                    </div>
                </li>
                        ...
                        <div class="create-count">
                            <b
                                >较昨日<em style="color: rgb(162, 90, 78)">{{
                                    caseNumChange(caseNum.suspectedIncr)
                                }}</em></b
                            >
                        </div>
                        <strong style="color: rgb(162, 90, 78)">{{
                            caseNum.suspectedCount
                        }}</strong>
                        <span>累计境外输入</span>
                    </div>
                </li>
                        ...
                        <div class="create-count">
                            <b
                                >较昨日<em style="color: rgb(174, 33, 44)">{{
                                    caseNumChange(caseNum.curedIncr)
                                }}</em></b
                            >
                        </div>
                        ...
                        <div class="create-count">
                            <b
                                >较昨日<em style="color: rgb(93, 112, 146)">{{
                                    caseNumChange(caseNum.deadIncr)
                                }}</em></b
                            >
                        </div>
                        ...
                        <div class="create-count">
                            <b
                                >较昨日<em style="color: rgb(40, 183, 163)">{{
                                    caseNumChange(caseNum.seriousIncr)
                                }}</em></b
                            >
                        </div>
                        <strong style="color: rgb(40, 183, 163)">{{
                            caseNum.seriousCount
                        }}</strong>
                        <span>现存无症状</span>
                    </div>
                </li>
